...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		$sql = "SELECT Id_Film, Name_Film, Eps_Number, Cover_address From Film Where Name_Film like '%" . $_REQUEST['search'] ."%'";
	...
	<main class="container">
		<div class="tray-title" style="color: white; background-color: #1C1C1C; border-right: 4px solid #2B2B2B; border-top: 4px solid #2B2B2B; border-bottom: 4px solid #2B2B2B;">
			<h5 style="color: #d14002;">Kết quả của: <span style="color: #44b2e5;"><?= $_REQUEST['search'] ?></span></h5>
		</div>
